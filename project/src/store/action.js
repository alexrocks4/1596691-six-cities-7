...
const ActionType = {
  ...
  REVIEW_CREATION_STARTED: 'api/createReviewRequest/creationStarted',
  REVIEW_CREATION_FAILED: 'api/createReviewRequest/creationFailed',
  REVIEW_CREATED: 'api/createReviewRequest/created',
  FAVORITE_OFFER_STATUS_UPDATING_STARTED: 'api/updateFavoriteOfferStatusRequest/updatingStarted',
  FAVORITE_OFFER_STATUS_UPDATING_FAILED: 'api/updateFavoriteOfferStatusRequest/updatingFailed',
  FAVORITE_OFFER_STATUS_UPDATED: 'api/updateFavoriteOfferStatusRequest/updated',
